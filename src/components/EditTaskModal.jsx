      ...
      return (
        <div className="form-group" style={{ marginBottom: 0 }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
            <input type="file" onChange={(e) => handleFileUpload(field, e.target.files[0])} style={{ display: 'none' }} id={`file-${field}`} />
            <label htmlFor={`file-${field}`} className="btn btn-secondary" style={{ cursor: 'pointer' }}>
